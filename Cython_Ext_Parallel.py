...
def add_sample(part, adj_Matrix,adj_Matrix_np, k, r, decor_step, reliability_list,g2g,group_size_vector,node_to_group, group_of_node,nonempty_groups,H):
    ...
    for rep in xrange(r):
       ...
       #profile.runcall(factor_MC_step, part_copy,adj_Matrix_np,k,decor_step, reliability_copy, g2g,group_size_vector,node_to_group, group_of_node, nonempty_groups)
       #profile.print_stats()
       l.append(part_copy)
       part = part_copy
...
def main():
    ...
    # print H
    # start_parts, g2g, group_size_vector,node_to_group, group_of_node, nonempty_groups, H = tu
    t_11 = time.time()
    
    print "time for starting partitions" , t_11-t_10
    
    t20 = time.time()
    # we don't need the sample here.
    ...
    #sample,reliability_list = add_sample(start_parts,adj_Matrix,adj_Matrix_np, k, reps, 65 , reliability_list_seq ,g2g, group_size_vector,node_to_group, group_of_node, nonempty_groups,H)
    t21 = time.time()
    ...
    #print "reliability" , reliability_dirty
    
    print len(sample_dirty)
    print len(sample_dirty[0])
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 19 14:56:51 2016
